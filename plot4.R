...
with(hc_feb07, {
  # First plot
  plot(Date_Time, Global_active_power, type = "l", ylab = "Global Active Power", xlab = "", col = "black")
  
  # Second plot
  plot(Date_Time, Voltage, type = "l", ylab = "Voltage", xlab = "", col = "black")
  ...
  # Fourth plot
  plot(Date_Time, Global_reactive_power, type = "l", ylab = "Global Active Power", xlab = "", col = "black")
})
